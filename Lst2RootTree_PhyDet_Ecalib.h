...
// Tue Feb  8 15:25:50 2022 by ROOT version 6.24/06
// from TTree Lst2RootTree_PhyDet_Ecalib/Lst2RootTree_PhyDet_Ecalib
// found on file: Lst2RootTree_PhyDet_Ecalib.root
//////////////////////////////////////////////////////////

#ifndef Lst2RootTree_PhyDet_Ecalib_h
#define Lst2RootTree_PhyDet_Ecalib_h
...
class Lst2RootTree_PhyDet_Ecalib {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxHPGe_Hits = 5;
   ...
   Lst2RootTree_PhyDet_Ecalib(TTree *tree=0);
   virtual ~Lst2RootTree_PhyDet_Ecalib();
...
Lst2RootTree_PhyDet_Ecalib::Lst2RootTree_PhyDet_Ecalib(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Lst2RootTree_PhyDet_Ecalib.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Lst2RootTree_PhyDet_Ecalib.root");
      }
      f->GetObject("Lst2RootTree_PhyDet_Ecalib",tree);

   }
   Init(tree);
}

Lst2RootTree_PhyDet_Ecalib::~Lst2RootTree_PhyDet_Ecalib()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Lst2RootTree_PhyDet_Ecalib::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Lst2RootTree_PhyDet_Ecalib::LoadTree(Long64_t entry)
{
...
void Lst2RootTree_PhyDet_Ecalib::Init(TTree *tree)
{
...
Bool_t Lst2RootTree_PhyDet_Ecalib::Notify()
{
...
void Lst2RootTree_PhyDet_Ecalib::Show(Long64_t entry)
{
...
Int_t Lst2RootTree_PhyDet_Ecalib::Cut(Long64_t entry)
{
